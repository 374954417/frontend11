            ...
            <div class="aside">
                <div class="border-box padding-16">
                    ...
                    <div class="flex-box">
                        ...
                        <div class="aside-label" style="margin-left: 38px">退房时间</div>
                    </div>
                    <div class="flex-box">
                        <div>
                            <div class="aside-title">{{GMTToStr(checkinvar)}}</div>
                            <div class="sub-title grey-text">14:00起</div>
                        </div>

                        <div style="margin-left: 15px">
                            <div class="aside-title">{{ GMTToStr(checkoutvar) }}</div>
                            <div class="sub-title grey-text">14:00起</div>
                        </div>
                    </div>
                    <div class="aside-label">入住总天数：</div>
                    <div class="sub-content">{{ calDay(checkinvar,checkoutvar) }}晚</div>
                ...
                <div class="border-box padding-16 mg-top-16">
                    <div class="discount-box flex-box justify-between align-center padding-16 mg-top-16">
                        ...
                        <div>
                            <div class="price-text text-right">{{ price }} 元</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="main">
                ...
                <div class="border-box padding-16 mg-bottom-16">
                    ...
                    <div class="flex-box align-center mg-top-16">
                        ...
                        <span style="margin-left: 15px">保持灵活：{{ GMTToStr2(checkinvar) }}前（含）可免费取消，所以今天就锁定该好价吧!</span>
